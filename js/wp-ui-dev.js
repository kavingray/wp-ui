	...
	this.each(function() {
		...
		$this.find('.ui-tabs-panel').children(o.h3Class).each(function() {
			...
			if ( jQuery(this).children(o.linkAjaxClass).length != 0 ) {
				...
				parID = jQuery(this).text().replace(/\s/gm, '_');
				...
				var parID = jQuery(this).text().replace(/\s/gm, '_') + '_' + uid++;
		...
		if ( o.effect == 'slideDown' ) {
		 	tabsobj.effect = { height: 'toggle', speed: o.effectSpeed};
		} else if ( o.effect == 'fadeIn' ) {
			tabsobj.effect = {opacity: 'toggle', speed: o.effectSpeed};
		}
		...
		$this.find('div.ui-tabs-panel').each(function(i) {
			...
			if ( i != 0 ) {
				! o.topNav || jQuery(this).children('.tab-top-nav').prepend('<a href="#" class="backward prev-tab">' + o.tabPrevText + '</a>');
				! o.bottomNav || jQuery(this).children('.tab-bottom-nav').append('<a href="#" class="backward prev-tab">' + o.tabPrevText + '</a>');		
			}
			
			if ( i != totalLength ) {
				! o.topNav || jQuery(this).children('.tab-top-nav').append('<a href="#" class="forward next-tab">' + o.tabNextText + '</a>');
				! o.bottomNav || jQuery(this).children('.tab-bottom-nav').append('<a href="#" class="forward next-tab">' + o.tabNextText + '</a>');			
